    ...
    public static class GlobalLocalisation
    {
        ...
        public static void Reload(LocalisationConfiguration localisationConfiguration = null)
        {
            ...
            if (localisationConfiguration == null)
                ...
                localisationConfiguration = Resources.Load<LocalisationConfiguration>("LocalisationConfiguration");
            ...
            if (setupMode == LocalisationConfiguration.SetupModeType.Auto)
            {
                ...
                if (LocalisationData == null)
                    Debug.LogWarning("GlobalLocalisation: No localisation data was found so creating an empty one. Please check that a localisation files exist at /Resources/Localisation or /Resources/Default/Localisation!");
            }
            else if (setupMode == LocalisationConfiguration.SetupModeType.Specified)
            {
                ...
                if (LocalisationData == null)
                    Debug.LogWarning("GlobalLocalisation: No localisation data was found so creating an empty one. Please check that localisation files exist and are in the correct location!");
            }
