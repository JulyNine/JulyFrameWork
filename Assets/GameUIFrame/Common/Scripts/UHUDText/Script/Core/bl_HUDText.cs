...
public class bl_HUDText : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        if (Event.current.type == EventType.Repaint)
        {
            for (int i = 0; i < texts.Count; i++)
            {
                ...
                //fade text
                temporal.m_Color -= new Color(0f, 0f, 0f, (Time.deltaTime * FadeSpeed * 3) / 100f);
    ...
    public void NewText(string text, HUDType hudType, Transform trans)
    {
        NewText(text, hudType, trans, bl_Guidance.Up);
    }
    /// <summary>
    /// 
    /// </summary>
    /// <param name="text"></param>
    /// <param name="trans"></param>
    public void NewText(string text, HUDType hudType, Transform trans, Color color)
    {
        NewText(text, hudType, trans, color, 8, 20f, 1, 2.2f, bl_Guidance.Up);
    }
    /// <summary>
    /// 
    /// </summary>
    ...
    public void NewText(string text, HUDType hudType, Transform trans, bl_Guidance place)
    {
        NewText(text, hudType, trans, Color.white, 8, 20f, 0, 2.2f, place);
    }
    /// <summary>
